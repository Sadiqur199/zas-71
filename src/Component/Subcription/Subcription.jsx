        ...
        <div className="w-[327px] h-[500px] p-10 shadow-md rounded">
          ...
          <ul className="mt-5">
            <li className="flex mb-2">
              {" "}
              <TbPointFilled className="mt-[3px] mr-1" size={12} />{" "}
              <span className="font-semibold text-xs">All 18 Lesson</span>
            </li>
            <li className="flex mb-2">
              {" "}
              <TbPointFilled className="mt-[3px] mr-1" size={12} />{" "}
              <span className="font-semibold text-xs">Source file</span>
            </li>
            <li className="flex">
              {" "}
              <TbPointFilled className="mt-[3px] mr-1" size={12} />{" "}
              <span className="font-semibold text-xs">Life time access</span>
            </li>
          </ul>
          <button className="w-[236px] h-[50px] rounded-full bg-[#5A5BCB] text-white mt-[110px]">
            Choose Plan
          </button>
        </div>
        {/* second Card */}
        <div className="w-[327px] h-[500px] p-10 shadow-md rounded">
          ...
          <ul className="mt-5">
            ...
            <li className="flex">
              {" "}
              <TbPointFilled className="mt-[3px] mr-1" size={12} />{" "}
              <span className="font-semibold text-xs">Commercial License</span>
            </li>
          </ul>
          <button className="w-[236px] h-[50px] rounded-full bg-[#5A5BCB] text-white mt-[70px]">
            Choose Plan
          </button>
        </div>
        {/* Third Card */}
